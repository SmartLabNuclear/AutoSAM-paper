...
# A5) Reactor total power was not provided; set ReactorPower.initial_power = 1.0 W so that the case runs.
#     (Temperatures/power will scale linearly with this choice.)
...
[Components]
  ...
  [Branch2]
    ...
    eos = eos
    inputs  = 'Pipe2(out)'
    outputs = 'CH1(in) CH2(in) CH3(in) CH4(in)'  # SEEDED DEFECT: CH5 disconnected
