...
[EOS]
  [eos_fuel]
    type = PTFunctionsEOS
    rho = fuel_rho              # MISSING: fuel_rho (PTFunctionsEOS function name)
    cp  = fuel_cp               # MISSING: fuel_cp (PTFunctionsEOS function name)
    mu  = fuel_mu               # MISSING: fuel_mu (PTFunctionsEOS function name)
    k   = fuel_k                # MISSING: fuel_k  (PTFunctionsEOS function name)
  []
  [eos_cool]
    type = PTFunctionsEOS
    rho = cool_rho              # MISSING: cool_rho (PTFunctionsEOS function name)
    cp  = cool_cp               # MISSING: cool_cp (PTFunctionsEOS function name)
    mu  = cool_mu               # MISSING: cool_mu (PTFunctionsEOS function name)
    k   = cool_k                # MISSING: cool_k  (PTFunctionsEOS function name)
  []
[]
...
[Components]
  ...
  [hx]
    ...
    twall_init = 908.15
    n_wall_elems = 1
    wall_material = hx_wall           # ENGINEERING ASSUMPTION: PBHeatExchanger requires a wall material name for conduction.
  []
