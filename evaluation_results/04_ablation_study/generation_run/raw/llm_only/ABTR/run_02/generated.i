...
[Components]
  [reactor]
    type = ReactorPower
    # Engineering assumption: ReactorPower is present for bookkeeping; core-channel power is apportioned via power_fraction in channels.
    # MISSING: reactor/total_power
  []
